...
**Started:** 2026-04-09
**Status:** In progress (Phase 0 + Phase 1 written; Phase 2-7 pending)
...
| 2 | BaseTool Refactor + WorkspacePath | 5 | 0 | ⏳ pending | phase-2-basetool.md |
| 3 | T2 File Tools | 8 | 2 | ⏳ pending | phase-3-file-tools.md |
| 4 | Bash + SetPhase + Stream Events | 8 | 2 | ⏳ pending | phase-4-bash-events.md |
