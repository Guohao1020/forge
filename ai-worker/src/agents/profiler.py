...
DIMENSION_PROMPTS = {
    "api_catalog": """You are analyzing source code to extract a complete API endpoint catalog.
...
""",
    "db_schema": """You are analyzing source code to extract database schema information.
...
""",
    "module_graph": """You are analyzing source code to extract module dependency information.
...
""",
    "architecture": """You are analyzing source code to extract high-level architecture information.
...
""",
    "business_rules": """You are analyzing source code to extract implicit and explicit business rules.
...
class ProfilerAgent(BaseAgent):
    ...
    def __init__(self, router, dimension: str = "architecture") -> None:
        super().__init__(router)
        self.dimension = dimension

    def _build_system_prompt(self, context: ProjectContext) -> str:
        base = PROFILER_SYSTEM_PROMPT
        dimension_prompt = DIMENSION_PROMPTS.get(self.dimension, "")
        if dimension_prompt:
