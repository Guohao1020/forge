    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs text-muted-foreground/60 mb-1">提交信息</p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          <p className="text-xs text-muted-foreground/60 mb-2">Review 评分</p>
          {reviewScore != null ? (
        ...
        {/* Risk level */}
        <div className="rounded-xl border border-border bg-card p-4">
          <p className="text-xs text-muted-foreground/60 mb-2">风险等级</p>
          {riskLevel ? (
            <Badge
              variant="secondary"
        ...
        {/* Files changed */}
        <div className="rounded-xl border border-border bg-card p-4">
          <p className="text-xs text-muted-foreground/60 mb-2">文件变更</p>
          <div className="flex items-center gap-2">
            <FileCode className="h-4 w-4 text-primary" />
            <span className="text-2xl font-bold text-foreground/80">{filesChanged}</span>
            <span className="text-sm text-muted-foreground/60">个文件</span>
          </div>
        </div>

        {/* Lines changed */}
        <div className="rounded-xl border border-border bg-card p-4">
          <p className="text-xs text-muted-foreground/60 mb-2">代码行数</p>
      ...
      {summary && (
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs text-muted-foreground/60 mb-1">Review 总结</p>
